+++
date = '2025-06-05T10:27:14+07:00'
draft = false
title = 'System Design Resources'
author = 'Huy Dang Quang'
categories = ["System Design"]
tags = ["system design"]
description = 'Tổng hợp nguồn tham khảo về System Design'
+++

This post contains free resources to learn System Design concepts and prepare for interviews.

I just clone [awesome-system-design-resources](https://github.com/ashishps1/awesome-system-design-resources?tab=readme-ov-file) repository, and save here for easy searching.

## 📌 System Design Key Concepts
- [30 most important System Design concepts](https://blog.algomaster.io/p/30-system-design-concepts)
